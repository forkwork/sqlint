...
test_type!(tinyint(mysql, "tinyint(4)", Value::Int32(None), Value::int32(i8::MIN), Value::int32(i8::MAX)));

test_type!(tinyint1(mysql, "tinyint(1)", Value::int32(-1), Value::int32(1), Value::int32(0)));

test_type!(tinyint_unsigned(mysql, "tinyint(4) unsigned", Value::Int32(None), Value::int32(0), Value::int32(255)));

test_type!(year(mysql, "year", Value::Int32(None), Value::int32(1984), Value::int32(2049)));

test_type!(smallint(mysql, "smallint", Value::Int32(None), Value::int32(i16::MIN), Value::int32(i16::MAX)));

test_type!(smallint_unsigned(mysql, "smallint unsigned", Value::Int32(None), Value::int32(0), Value::int32(65535)));

test_type!(mediumint(mysql, "mediumint", Value::Int32(None), Value::int32(-8388608), Value::int32(8388607)));
...
test_type!(int(mysql, "int", Value::Int32(None), Value::int32(i32::MIN), Value::int32(i32::MAX)));
...
test_type!(bigint(mysql, "bigint", Value::Int64(None), Value::int64(i64::MIN), Value::int64(i64::MAX)));
...
test_type!(decimal_65_6(
    mysql,
    "decimal(65, 6)",
    Value::numeric(BigDecimal::from_str("93431006223456789876545678909876545678903434334567834369999.345678")?),
));
...
test_type!(float_decimal(
    ...
    (Value::numeric(bigdecimal::BigDecimal::from_str("3.14").unwrap()), Value::float(3.14))
));
...
test_type!(bit64(mysql, "bit(64)", Value::Bytes(None), Value::bytes(vec![0, 0, 0, 0, 0, 6, 107, 58])));
...
test_type!(mediumtext(mysql, "mediumtext", Value::Text(None), Value::text("foobar")));

test_type!(tinyblob(mysql, "tinyblob", Value::Bytes(None), Value::bytes(vec![1, 2, 3])));

test_type!(mediumblob(mysql, "mediumblob", Value::Bytes(None), Value::bytes(vec![1, 2, 3])));

test_type!(longblob(mysql, "longblob", Value::Bytes(None), Value::bytes(vec![1, 2, 3])));
...
#[cfg(feature = "chrono")]
test_type!(time(mysql, "time", Value::Time(None), Value::time(chrono::NaiveTime::from_hms_opt(16, 20, 00).unwrap())));

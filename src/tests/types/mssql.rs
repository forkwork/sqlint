...
test_type!(nvarchar_limited(mssql, "NVARCHAR(10)", Value::Text(None), Value::text("foobar"), Value::text("余"),));
...
test_type!(ntext(mssql, "NTEXT", Value::Text(None), Value::text("foobar"), Value::text("余"),));

...
//!   `SERIALIZABLE`.
//!
//! To create a new `Sqlint` pool connecting to a PostgreSQL database:
//!
//! ``` no_run
...
//!     let mut builder = Sqlint::builder("postgresql://postgres:password@localhost:5432/postgres")?;
...
//! ```
//!
//! [`builder`]: struct.Sqlint.html#method.builder
...
/// A `Builder` to construct an instance of a [`Sqlint`] pool.
///
/// [`Sqlint`]: pooled.Sqlint
pub struct Builder {
...
impl Builder {
    ...
    ///
    /// [`check_out`]: struct.Sqlint.html#method.check_out
...
impl Sqlint {
    /// Creates a new builder for a Sqlint connection pool with the given

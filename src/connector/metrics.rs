...
{
    let span = info_span!("sqlint:query", "db.statement" = %query);
    ...
    U: Future<Output = crate::Result<T>>,
{
    ...
    histogram!("khulnasoft_datasource_queries_duration_histogram_ms", start.elapsed());
    increment_counter!("khulnasoft_datasource_queries_total");
